...
func TestKnapsackN_Recursive1(t *testing.T) {
	w := [...]int{10, 20, 30}
	v := [...]int{60, 100, 120}
	n := [...]int{1, 1, 1}
	c := 50
	result := KnapsackN_Recursive(w[:], v[:], n[:], c)
	assert.Equal(t, result, 220)
}

func TestKnapsackN_Recursive2(t *testing.T) {
...
func TestKnapsackN_Recursive3(t *testing.T) {
...
func TestKnapsackN_Recursive4(t *testing.T) {
	w := [...]int{1, 2, 3, 4, 5, 6, 7, 8}
